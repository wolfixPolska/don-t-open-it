...
class VirtualKeyboard:
    ...
    def __init__(self, master=Tk()):
        ...
        Label(infoframe7, text="Made with Love...\nedited by wolfix__", bg=self.gray, fg="white", font=self.neetfont).grid(row=0, column=10, sticky="NSEW")
    ...
    def vpresskey(self, x):
        ...
        #self.master.after(10, keyboard.send("alt+tab"))
        hwnd_l = window_stack.get_app_window_stack()
        self.master.after(10, window_stack.set_active_window(hwnd_l[1]))  
        self.master.after(80, keyboard.send(x))
        #self.master.after(50, keyboard.send("alt+tab"))
    ...
    def mainloop_tick(self):   
        self.master.update_idletasks()  # Process idle tasks
